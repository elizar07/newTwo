			...
			<div className='container'>
				...
				<div className='contact'>
					...
					<div className='contact-big-block'>
						<h1>
							Обсудить проект, договориться об онлайн-встрече или задать вопрос.
						</h1>
						<p>
							Свяжитесь со мной любым удобным способом или оставьте заявку, я
							буду рад узнать о продукте и проконсультировать.
						</p>
						<h2>Мой номер</h2>
						...
						<div className='form'>
							...
							<form class='max-w-sm mx-auto'>
								<div class='flex items-center mt-2'>
									...
									<label
										for='phone-input'
										class='text-sm font-medium sr-only text-gray-900 dark:text-white'
									>
										Phone number:
									</label>
									<div class='relative w-full'>
										<input
											...
											class='block p-2.5 w-full z-20 text-sm text-gray-900 bg-gray-50 border-e-0 border-s-0 border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-s-gray-700  dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:border-blue-500'
								...
								<button
									type='submit'
									class='text-white w-full bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mt-4 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800'
								>
									Activate account
								</button>
							</form>
